...
import 'package:music_app/screen/player.dart';
import 'package:music_app/screen/songClient.dart';
import 'package:music_app/screen/songModel.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<List<SongModel>> _getSongsFromAPI() async {
    Map<String, dynamic> cMap =
        await songClient.getSongFromItunes('TRAVIS SCOTT');
